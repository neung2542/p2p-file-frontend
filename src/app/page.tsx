...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col gradient-bg">
      ...
      {/* Main content */}
      <main className="flex-1 container flex flex-col items-center justify-center max-w-5xl py-12 mx-auto">
        <div className="text-center space-y-8 w-full max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <Link href="/send">
              <Button
                size="lg"
                className="w-full sm:w-auto group px-6 py-6 rounded-xl hover-lift cursor-pointer"
              >
                Send Files
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-24">
          <div className="p-6 rounded-xl subtle-border hover-lift bg-background/50">
            ...
            <h3 className="text-lg font-medium mb-2">No Login</h3>
            <p className="text-muted-foreground text-sm">
              No need to create an account or log in. Just open the app and
          ...
          <div className="p-6 rounded-xl subtle-border hover-lift bg-background/50">
            ...
            <p className="text-muted-foreground text-sm">
              WebSocket connections provide the fastest possible transfer
              speeds.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl subtle-border hover-lift bg-background/50">
            ...
            <p className="text-muted-foreground text-sm">
              Transfer files of any size without the restrictions of email or
              cloud storage.
            </p>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="container py-6 text-center text-sm text-muted-foreground"></footer>
    </div>
  );
}
